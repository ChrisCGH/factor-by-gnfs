...
void zaddmulp(long *a, long b, long d, long *t);
/******************************************************************\
* a = (a + t + b * d) % RADIX; and simultaneously
* t = (a + t + b * d) / RADIX;
\******************************************************************/

void zaddmulpsq(long *a, long b, long *t);
/******************************************************************\
...
void zaddmul(long d, verylong a, verylong b);
/******************************************************************\
* a += d * b;
* a and b not at overlapping addresses (except if d=1)
\******************************************************************/

void zaddmulsq(long d, verylong a, verylong b);
/******************************************************************\
* a += b[0] * b[1:d];
* a and b not at overlapping addresses (except if d=1)
\******************************************************************/

void zmmulp(verylong a);
/******************************************************************\
* a[s:] += (a[s] * zminv) * zn;
...
long zisone (verylong a);
/******************************************************************\
* if (a == 1)
*     return (1);
* if (a != 1)
*     return (0);
* added by CTC: 8/4/2002
\******************************************************************/
